 ...
 * BTServiceHelper
 */
public class BTServiceHelper {
    // Debugging
    private static final String TAG = BTServiceHelper.class.getSimpleName();
     ...
     */
    public BTServiceHelper(Context context, Handler handler) {
...
//                    BluetoothDevice device = device1;
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(GlobalParams.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(GlobalParams.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(GlobalParams.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(GlobalParams.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(GlobalParams.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
...
//                tmp = device.createRfcommSocketToServiceRecord(MY_UUID); // SECURE
        ...
        public void run() {
            ...
            try {
                ...
                BTServiceHelper.this.start();
                return;
            }

            // Reset the ConnectThread because we're done
            synchronized (BTServiceHelper.this) {
                mConnectThread = null;
            }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(GlobalParams.MESSAGE_READ, bytes, -1, buffer).sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(GlobalParams.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
            } catch (IOException e) {
