...
//    @BindView(R.id.tv_r6_stored_bill_count) TextView mStoredBillCountTv;
    ...
    private CardView mSelectedBillView, mSelectedStackView;
    ...
    protected void initFragment() {
        ...
        MyVars.fragmentExecutor.execute(new IdentifyBucketTask());
        MyVars.fragmentExecutor.scheduleWithFixedDelay(new DeliveryBillQueryTask(), 0, 10, TimeUnit.SECONDS);
    }
